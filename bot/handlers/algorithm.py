...
@bot.callback_query_handler(func=lambda call: call.data in ['calc_income', 'devices_catalog'])
async def choose_algorithm(call):
    if call.data == 'calc_income' or call.data == 'devices_catalog' or call.data == 'back' or call.data =='add_more':
        if call.data in ['calc_income', 'devices_catalog']:
